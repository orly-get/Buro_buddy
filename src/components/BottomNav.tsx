...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 w-full z-50 flex justify-around items-center px-2 pb-8 pt-3 bg-white/95 backdrop-blur-lg rounded-t-[32px] border-t border-pink-100 shadow-[0_-10px_40px_rgba(255,107,138,0.15)] md:hidden">
      {navItems.map((item) => {
